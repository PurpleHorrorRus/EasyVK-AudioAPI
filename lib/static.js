...
class Static {
    ...
    async getDataByBlock (context, params, field) {
        ...
        if (params.count) {
            ...
            if (params.all) {
                ...
                while (more !== null) {
                    const data = await this.getDataWithMore(context, more, params, field);
                    list = [...list, ...data.list];
                    more = data.more;
                }
            }
    ...
    async getDataWithMore (context, more, params = {}, field) {
        ...
        if (typeof response === "object") {
            list = !field
                ? context.builder(Array.isArray(response.payload[1][0]) 
                    ? response.payload[1][0].join("") 
