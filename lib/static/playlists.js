...
class PlaylistsStatic extends Static {
    ...
    parseLink (object) {
        ...
        return object
            ? { 
                ...
                params: querystring.decode(object.attributes.href.replace(/(.*?)\?/, ""))
            }
            : {};
    }
    ...
    buildCollection (object) {
        return {
            ...
            playlists: this.buildPlaylists(object.querySelector(this.classes.PLAYLIST.COLLECTIONS.PAGE).innerHTML),
