...
class PlaylistsStatic extends Static {
    constructor (client, params) {
        ...
        this.classes = {
            ...
            CELEBRITIES: {
                block: ".CatalogBlock__celebrities_playlists_web_header",
    ...
    getAuthor (playlist) {
        ...
        return {
            ...
            name: authorLine.match(authorNameRegex)[1]
        };
    }
    ...
    async getRecommended(page, params) {
        ...
        return {
            users_playlists: await this.buildRecommendedBlock(block, users_playlists, params),
            celebrities: await this.buildRecommendedBlock(celebritiesBlock, celebrities, params)
        };
    }
