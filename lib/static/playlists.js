...
class PlaylistsStatic extends Static {
    ...
    build (html) {
        return HTMLParser.parse(html).querySelectorAll("._audio_pl_item").map(block => {
            ...
            const sizeBlock = block.querySelector(".audio_pl__stats_count"),
                listensBlock = block.querySelector(".audio_pl__stats_listens");
