...
class AudioStatic extends Static {
    ...
    getAudioAsObject (audio = [], params = {}) {
        const source = this.UnmuskTokenAudio(audio[this.AudioObject.AUDIO_ITEM_INDEX_URL], this.user, params);
        ...
        return {
            ...
            url: source || "",
            artists: audio[this.AudioObject.AUDIO_ITEM_INDEX_MAIN_ARTISTS],
            ...
            lyrics_id: audio[this.AudioObject.AUDIO_ITEM_INDEX_LYRICS],
            add_hash: e[0] || "",
            edit_hash: e[1] || "",
            action_hash: e[2] || "",
            delete_hash: e[3] || "",
