...
const DownloadInstance = require("../hls");
...
class AudioStatic extends Static {
    ...
    getAudioObject (audio = {}) {
        audio = {
            ...
            is_restriction: Boolean(audio.restrictionStatus),
        ...
        audio.download = async (params = {}) => {
            return await this.downloadFunction(audio, params);
        };
    ...
    getAudioAsObject (audio = []) {
        ...
        audio = {
            ...
            covers: c?.replaceAll("&amp;", "&"),
            is_restriction: Boolean(audio[this.AudioObject.AUDIO_ITEM_INDEX_RESTRICTION]),
            extra: JSON.parse(audio[this.AudioObject.AUDIO_ITEM_INDEX_EXTRA]),
    ...
    async downloadFunction (audio, params = {}) {
        return await new DownloadInstance(audio, params).download();
    }
